...
def dashboard():
    ...
    return render_template("dashboard.html", record=record, today=today)
...
def mark_attendance():
    ...
    try:
        ...
        db.execute(
            """
            INSERT INTO attendance (user_id, attendance_date, check_in_time)
            VALUES (?, ?, ?)
            """,
        ...
        flash("Attendance has already been recorded for today.")
